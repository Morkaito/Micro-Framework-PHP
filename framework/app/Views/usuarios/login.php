...
<div class="section">
    <div class="container">  
        <form id="contact" action="" method="post">
            <h3>Login</h3>
            <h4>Informe os dados abaixo para fazer login</h4>
            ...
            <fieldset>
                ...
                <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Logar</button>
            </fieldset>
                <p class="copyright"><a href='<?= URL ?>./usuarios/register'>Você não tem uma conta? Faça seu cadastro</a></p>
        </form>
    </div>
</div>